...
from deployed_functions import FaissIndex
...
# download_embedding_model_to_volume = modal.Function.lookup("philosophy-question-answerer", "download_embedding_model_to_volume")
# embedding_model_name = 'sentence-transformers/all-MiniLM-L6-v2'
# download_embedding_model_to_volume.remote(embedding_model_name)
